...
lyr_Hvidovre.setZIndex(9999);
lyr_Hvidovre.setVisible(true);
lyr_Hvidovre.set('title', '');
map.addLayer(lyr_Hvidovre);

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit(
    [1378198.456720, 7478079.000560, 1397278.503594, 7493072.109716],
